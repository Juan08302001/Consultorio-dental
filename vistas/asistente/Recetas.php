...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/ConsultorioDental/controlador/Asistente/ControladorRecetas.php" method="post">
                <div class="mb-3">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <form action="/ConsultorioDental/pdf/Receta.php" method="get" class="d-inline">
                <div class="form-group">
                    <label for="paciente_id_pdf" class="sr-only">Paciente</label>
                    <select class="form-control form-control-sm d-inline" id="paciente_id_pdf" name="paciente_id_pdf" required>
                        <option value="" disabled selected>Seleccione un paciente</option>
                        <?php echo $optionsPacientes; ?>
                    </select>
                </div>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($resultRecetas)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="/ConsultorioDental/controlador/Asistente/ControladorRecetas.php" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta receta?');" style="display:inline;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formModificarReceta" action="/ConsultorioDental/controlador/Asistente/ControladorRecetas.php" method="post">
