...
<script>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/ConsultorioDental/controlador/Dentista/ControladorCitas.php" method="POST">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td>
                                            ...
                                            <form action='/ConsultorioDental/controlador/Dentista/ControladorCitas.php' method='POST' class='d-inline' onsubmit='return confirm(\"¿Estás seguro de que deseas eliminar este paciente?\");' style='display:inline;'>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editCitaForm" action="/ConsultorioDental/controlador/Dentista/ControladorCitas.php" method="POST">
