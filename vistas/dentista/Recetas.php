...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/ConsultorioDental/controlador/Dentista/ControladorRecetas.php" method="post">
                <div class="mb-3">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($resultRecetas)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="/ConsultorioDental/controlador/Dentista/ControladorRecetas.php" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta receta?');" style="display:inline;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formModificarReceta" action="/ConsultorioDental/controlador/Dentista/ControladorRecetas.php" method="post">
