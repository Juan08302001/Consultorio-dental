...
<body>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/ConsultorioDental/controlador/ControladorPacientes.php" method="POST">
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td>
                                            ...
                                            <form action='/ConsultorioDental/controlador/ControladorPacientes.php' method='POST' onsubmit='return confirm(\"¿Estás seguro de que deseas eliminar este paciente?\");' style='display:inline;'>
